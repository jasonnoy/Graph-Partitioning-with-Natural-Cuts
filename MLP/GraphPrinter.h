...
public:
    ...
    GraphPrinter(const vector<NodeID>& void_nodes, vector<EdgeID>& cellEdges): void_nodes(void_nodes), cell_edges(cellEdges), id_map(replace_vec_vec), real_map(replace_vec), a_result(replace_vec_vec), contract_tiny(false){}
