...
//        cout<<"adj size of node: "<<node_list[edge.get_source()].get_adj_list().size()<<endl;
    ...
    cout<<"node 0: oid: "<<edge_list[0].get_origin_id()<<" source: "<<node_list[edge_list[0].get_source()].get_origin_id()
    <<" target: "<<node_list[edge_list[0].get_target()].get_origin_id()<<endl;
