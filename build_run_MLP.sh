...
g++ ./MLP/MultiLayerPartition.cpp -lpthread -g ./MLP/Assembly.cpp ./MLP/Filter.cpp ./MLP/AdaptivePrinter.cpp ./MLP/Preprocess.cpp ./MLP/GraphPrinter.cpp ./Common/Utility.cpp ./PUNCH/Filter/G_Graph.cpp ./PUNCH/Assemble/A_Graph.cpp -o ./bin/MLP -std=c++11 > ./logs/"$date_str"/"$time_str".log

./bin/MLP ./data/paras.txt ./data/nodes_all ./data/links ./result/ 33 >> ./logs/"$date_str"/"$time_str".log
echo "Finished"