...
./bin/MLP ./data/paras.txt /data/map_data/rp_2.0/normal/2021_11_25_21_07_41/all/all/nodes_all /data/map_data/rp_2.0/normal/2021_11_25_21_07_41/all/all/links_all ./result/ 32 >> ./logs/"$date_str"/"$time_str".log 2>&1
