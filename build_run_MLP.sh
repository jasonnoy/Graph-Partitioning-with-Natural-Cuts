...
./bin/MLP ./data/paras.txt /data/cris.su/code/ch-routing-demo/data/china/nodes /data/cris.su/code/ch-routing-demo/data/china/links ./result/china_result/ 32 >> ./logs/"$date_str"/"$time_str".log 2>&1
