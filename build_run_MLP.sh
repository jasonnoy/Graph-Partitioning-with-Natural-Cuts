...
./bin/MLP ./data/paras.txt /data/cris.su/code/ch-routing-demo/data/china/nodes /data/cris.su/code/ch-routing-demo/data/china/links ./result/ 56 >> ./logs/"$date_str"/"$time_str".log 2>&1

 ./bin/MLP ./data/paras_beijing.txt ./data/nodes_all ./data/links ./result/beijing/ 52 >> ./logs/"$date_str"/"$time_str".log 2>&1
