...
# topo china input
./bin/MLP ./data/paras.txt ./result/ 60 "$date_str$time_str" /data/lirb/navi-compile-pipeline/build_output_0/output_data/all_data/binary_data/crp_weight_dist.hllnavi >> ./logs/"$date_str"/"$time_str".log 2>&1
