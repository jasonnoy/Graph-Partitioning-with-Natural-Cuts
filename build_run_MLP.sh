...
#./bin/MLP ./data/paras.txt /data/map_data/rp_2.0/normal/2021_11_25_21_07_41/all/all/nodes /data/map_data/rp_2.0/normal/2021_11_25_21_07_41/all/all/links ./result/ 48 >> ./logs/"$date_str"/"$time_str".log 2>&1
 ...
 ./bin/MLP ./data/paras_beijing.txt /data/jjh/mlp_test/Graph-Partitioning-with-Natural-Cuts/data/beijing/binary_data/nodes /data/jjh/mlp_test/Graph-Partitioning-with-Natural-Cuts/data/beijing/binary_data/links ./result/beijing/ 32 >> ./logs/"$date_str"/"$time_str".log 2>&1
